...
using OidcSample.IdentityServer;
...
{
    public class AzureOidcViewModel : INotifyPropertyChanged
    {
        ...
        public AzureOidcViewModel()
        {
            ...
            ExecuteCopyAccessToken = new Command(execute: () => Clipboard.SetTextAsync(_credentials?.AccessToken));
            ExecuteCopyIdentityToken = new Command(() => Clipboard.SetTextAsync(_credentials?.IdentityToken));
        }
