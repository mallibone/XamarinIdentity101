...
namespace OidcSample
{
    public partial class App : Application
    {
        ...
        public const string CallbackUriAzure = "oidcxamarin101";
        public static readonly string CallbackSchemeAzure = $"{CallbackUri}://authenticated";
        public static readonly string SignoutCallbackSchemeAzure = $"{CallbackUri}://signout-callback-oidc";
