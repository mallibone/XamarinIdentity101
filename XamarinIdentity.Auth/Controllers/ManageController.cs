...
using XamarinIdentity.Auth.Models.ManageViewModels;
using XamarinIdentity.Auth.Models;
using XamarinIdentity.Auth.Services;
...
namespace XamarinIdentity.Auth.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            await _emailSender.SendEmail(
               model.Email,
               "XamarinIdentity.Auth Verification Email",
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("XamarinIdentity.Auth"),
